...
@app.route("/AdminHome")
def AdminHome():
    conn = mysql.connector.connect(user='root', password='', host='localhost', database='2retinodoctor')
    cur = conn.cursor()
...
def lung():
    if request.method == 'POST':
        ...
        if result[0][0] == 1:
            print("DR1")
            session['Ans'] = 'Yes'
            out = "Result", 'Type 1 Diabetes'
            pre = "prescription", 'Short-acting (regular) insulin'


        elif result[0][1] == 1:
            print("DR2")
            session['Ans'] = 'Yes'
            out = "Result", 'Type 2 Diabetes'
            pre = "prescription", 'Possibly, diabetes medication or insulin therapy'
            ...
            print("Normal")
            session['Ans'] = 'Yes'
            out = "Result", "Classification Result : "
            pre = "nil"
